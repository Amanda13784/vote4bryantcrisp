            ...
            <section id="issues" className="py-12 sm:py-16 md:py-20 bg-gray-100 text-gray-800" aria-labelledby="issues-heading">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8" role="list">
                        {[
                            {title: "Downtown Development & Economic Growth", description: "Bryant wants to continue to drive more businesses to Gibsonville to help ensure a strong commercial tax base. This will help Gibsonville move closer towards getting its Main Street Designation. It will also provide more options for our residents to utilize."},
